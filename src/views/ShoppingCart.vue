                                ...
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr v-for="keranjang in keranjangUser" :key="keranjang.id">
                                            ...
                                            <td @click="removeItem(keranjangUser.index)"  class="delete-item"><a href="#">
...
export default {
  ...
  methods: {
      ...
      checkout() {
        ...
        axios 
        .post(
            "https://shayna-backend.belajarkoding.com/api/checkout", checkoutData)
  ...
  computed: {
      totalHarga() {
          //bisa dijalankan tanpa adanya event(kaya onclick dsbnya)
